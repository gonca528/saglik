...
<section class="px-6 py-8" style="background-color: #dddcdc;">
    <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
        ...
        <div class="container">
            <form method="POST" action="/admin/update/tarif/{{ $user->id }}" class="mt-10"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <textarea rows="5" cols="20" type="text" name="body" id="body" required class="ckeditor"
                               required>   {{ old('body', $user->body) }}</textarea>
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <textarea rows="5" cols="20" type="text" name="title" id="title" required class="ckeditor"
                               required>   {{ old('title', $user->body) }}</textarea>
