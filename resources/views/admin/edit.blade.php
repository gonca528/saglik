...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">
      <img src="https://icons.veryicon.com/png/o/miscellaneous/yuanql/icon-admin.png" width="30" height="30" alt="">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a  style="color:black"class="nav-link" href="/index">Slider Düzenle <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
...
<section class="px-6 py-8" style="background-color: #dddcdc;">
    <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
        <h1 style="margin-top: 90px;" class="text-center font-bold text-xl">Slider Güncelle</h1>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <textarea  rows="5" cols="20"  type="text" name="excerpt" id="excerpt" required  class="ckeditor" name="excerpt" id="excerpt" required>  {{ old('excerpt',$user->excerpt) }}</textarea>
