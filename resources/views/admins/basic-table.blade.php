                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="/sliders" target="_blank"
                                class="btn btn-primary  d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">Slider
                                Ekle
                            </a>
                        </div>
                    </div>
                    ...
                    <tbody>
                        @foreach ($slider as $sliders)
                            <tr>
                                ...
                                <td>{{ $sliders->title }}</td>
                                <td class="">
                                    <form method="POST" action="/admin/update/slider/{{ $sliders->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-outline-dark"> Slider Sil</button>
                                    </form>
                                </td>
                                <td> <a class="btn btn-outline-dark" href="/admin/slider/{{ $sliders->id }}/edit/">
                                        Slider Güncelle
