                    ...
                    <tbody>
                        @foreach ($slider as $sliders)
                            <tr>
                                ...
                                <td class="">
                                    <form method="POST" action="/admin/update/tarif/{{ $sliders->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-outline-dark"> Gönderi Sil</button>
                                    </form>
                                </td>
                                <td> <a class="btn btn-outline-dark" href="/admin/tarif/{{ $sliders->id }}/edit/">
                                        Gönderi Güncelle
