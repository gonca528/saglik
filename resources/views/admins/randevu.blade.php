            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Randevular</h4>
                    </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($randevu as $sliders)
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="/admin/update/randevu/{{ $sliders->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-outline-dark"> Randevu Sil</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
