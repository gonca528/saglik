...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="admin/posts/tarif/new" target="_blank"
            ...
            <div class="container">
                <form method="POST" action="/admin/new/diyetisyen" class="mt-10" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea rows="5" cols="20" class="ckeditor" type="text" name="üniversite" id="üniversite"
                                    required>{{ old('üniversite') }}</textarea>
                                @error('üniversite')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                                    </p>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea rows="10" cols="20" class="ckeditor" type="text" name="şehir" id="şehir" required>{{ old('şehir') }}</textarea>
                                @error('şehir')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                                    </p>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea rows="10" cols="20"class="ckeditor" type="text" name="diller" id="diller" required>{{ old('diller') }}</textarea>
                                @error('diller')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                                    </p>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea rows="10" cols="20" class="ckeditor" type="text" name="bilgi" id="bilgi" required>{{ old('bilgi') }}</textarea>
                                @error('bilgi')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                                    </p>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea rows="10" cols="20" class="ckeditor" type="text" name="ünvan" id="ünvan" required>{{ old('ünvan') }}</textarea>
                                @error('ünvan')
                                    <p class="text-red-500 text-xs mt-1">
                                        {{ $message }}
                                    </p>
